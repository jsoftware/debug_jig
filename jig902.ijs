NB. Version 2.0 for this add on - QTide tooltips used - J902 based on j807 because of tooltips testfile load '/users/bobtherriault/j807-user/projects/enhanced/runjig807.ijs'
NB. This version IS NOT NECESSARY as beta reverted to j901 behaviour  It is included for archival purposes if jqt tooltip behaviour occurs again. 
...
tt=. '<title>',(30#'='),(55({.!.B)' Non-Sparse',B,'Entries',B,':',B,(": 7 $. y)),(55({.!.B)' Value',B,'Type',B,':',B,(7 }. datatype y)),(40{.' Sparse',B,'Element',B,':',B,(": 3 $. y)),(30#'='),'</title>'
...
tt=. '<title>',(30#'='),(55({.!.B)' Type',B,':',B,x),(40{.' Array',B,'Shape ',B,':',B, (": $ y)),(30#'='),'</title>'
...
tt=. '<title>',"1(30#'='),"1(65({.!.B)"1(' Label',B,'Type',B,':',B),"1(;"1 slt),"1' '),"1(65({.!.B)"1(' Index',B,':',B),"1(;"1(":each ,. , 6 s: y))),"1(40{."1(' Total',B,'Symbols',B,'Assigned:',B),"1(": 0 s: 0)),"1(30#'='),"1'</title>'
...
case. 'j807' do. load '/users/bobtherriault/j64-807-user/projects/enhanced/runjig807.ijs'
case.        do. smoutput 'not supported!' end.
)
NB. testsuite ''
