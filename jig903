...
'depth s b path'=. x 
tt=. ' Integer  ',LF,' Shape: ',((''-:  $ y){::((":  $ y);'atom')),(; b{'';(LF,LF,' Depth: ',(":depth),LF,' Path: ',(}: path)))
...
'depth s b path'=. x 
tt=. ' Floating  ',LF,' Shape: ',((''-:  $ y){::((":  $ y);'atom')),(; b{'';(LF,LF,' Depth: ',(":depth),LF,' Path: ',(}: path)))
...
vis_z_ =:   3 : '((1;coname 0$0) visual_jig_ 0:) y'
